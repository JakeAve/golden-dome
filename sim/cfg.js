...
// ---- CONFIG
/** @typedef {{hp:number,T:number,dmg:number,$:number,r:number,from?:number,to?:number,count?:(n:number)=>number,elite?:number,info?:string,pips?:number,shedEvery?:number}} Threat */
export const CFG = {
  startCash: 700,
  maxWave: 30,
  cityHP: 100,
  ...
  wave: {
    ...
    salvoBase: 0.25,
    salvoPerWave: 0.01, // multi-launch chance from wave 10
    pureFrom: 21, // from here mk1 fodder stops (threats with to: 20) and launches space out to pureGap
    pureGap: 40,
    pureGapPerWave: 1,
  },
